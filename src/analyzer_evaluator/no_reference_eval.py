...
def evaluate_no_reference(
    ...
    if previous_image is not None:
        ...
        result["delta_sharpness"] = float(
            curr_metrics.sharpness_laplacian_var - prev_metrics.sharpness_laplacian_var
        )
    ...
    try:
        ...
        result["estimated_quality_score"] = float(
            max(0.0, 100.0 - curr_metrics.noise_variance * 2.0)
        )
    except Exception:
